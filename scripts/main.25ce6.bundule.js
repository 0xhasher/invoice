...
// EXTERNAL MODULE: ./node_modules/.pnpm/wagmi@2.14.15_@tanstack+query-core@5.69.0_@tanstack+react-query@5.69.0_react@18.3.1__@types+r_qktm6uktfq655p55xcblci2udi/node_modules/wagmi/dist/esm/hooks/useWaitForTransactionReceipt.js + 2 modules
var useWaitForTransactionReceipt = __webpack_require__(88805);
...
function useWriteContractWithReceipt({ chain, eventName, confirmations = 1 }) {
    ...
    const { data: receipt, isFetching: txReceiptIsFetching, isSuccess: isConfirmed, isError: txReceiptIsError, error: txReceiptError } = (0,useWaitForTransactionReceipt/* useWaitForTransactionReceipt */.g)({
        hash: txHash,
        chainId: (_chain_id = chain == null ? void 0 : chain.id) != null ? _chain_id : DEFAULT_CHAIN.id,
        confirmations,
        query: {
            enabled: !!txHash
        }
                ...
                yield writeContractAsync(args, {
                    onSuccess: /*#__PURE__*/ (0,_async_to_generator._)(function*(_txHash) {
                        ...
                        if ((_receipt == null ? void 0 : _receipt.status) === 'success') {
                            ...
                            options == null ? void 0 : (_options_onSuccess = options.onSuccess) == null ? void 0 : _options_onSuccess.call(options, _receipt);
                        }
                    })
                });
            }
...
const CreateInvoice = ()=>{
    ...
    const isValidInvoiceForm = !!invoiceDate && !!dueDate && !!sellerName && // !!sellerAbn &&
    // isValidAbn(sellerAbn) &&
    !!buyerName && !!buyerAddr && // !!buyerAbn &&
    // isValidAbn(buyerAbn) &&
    isValidWalletAddress && isValidItems;
    (0,react.useEffect)(()=>{
        window.scrollTo(0, 0);
    }, []);
