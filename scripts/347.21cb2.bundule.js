"use strict";
(self["webpackChunktokenised_invoice_interface"] = self["webpackChunktokenised_invoice_interface"] || []).push([[347],{
...
/* harmony export */ });
/* harmony import */ var _walletconnect_modal_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59929);
...
class WalletConnectModal {
  ...
  async initUi() {
    if (typeof window !== "undefined") {
      await __webpack_require__.e(/* import() */ 350).then(__webpack_require__.bind(__webpack_require__, 41350));
...
;// ./node_modules/.pnpm/valtio@1.11.2_@types+react@18.3.19_react@18.3.1/node_modules/valtio/esm/vanilla.mjs
...
;// ./node_modules/.pnpm/@walletconnect+modal-core@2.7.0_@types+react@18.3.19_react@18.3.1/node_modules/@walletconnect/modal-core/dist/index.js
/* provided dependency */ var Buffer = __webpack_require__(84686)["hp"];
...
const CoreUtil = {
  ...
  setWalletConnectDeepLink(href, name) {
    try {
      ...
      dist_console.info("Unable to set WalletConnect deep link");
    }
  },
  setWalletConnectAndroidDeepLink(wcUri) {
    try {
      ...
      dist_console.info("Unable to set WalletConnect android deep link");
    }
  },
  removeWalletConnectDeepLink() {
    try {
      ...
      dist_console.info("Unable to remove WalletConnect deep link");
    }
  },
  setModalVersionInStorage() {
    try {
      ...
      dist_console.info("Unable to set Web3Modal version in storage");
    }
  },
  getWalletRouterData() {
    var _a;
